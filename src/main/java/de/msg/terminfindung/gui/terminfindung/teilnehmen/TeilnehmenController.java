...
public class TeilnehmenController extends AbstractController<TeilnehmenModel> {
    ...
    /**
     * Aktualisiert die abhängigen Daten im Model anhand der vorhandenen Terminfindung. Diese Methode ist vom Laden der
     * Terminfindung getrennt, um ggf. bei Änderungen am Terminfindungs-Attribut des Models die davon abhängigen Daten
     * des Models neu berechnen zu können, ohne die Terminfindung wieder neu aus dem Anwendungskern zu laden.
     *
     * @param model Das Model.
     */
    ...
    /**
     * Speichern eines neuen Teilnehmers und seiner Tag-Präferenzen. Ruft den AWK auf, um den Teilnehmer samt seiner
     * Praeferenzen zu den Zeitraeumen in der DB zu speichern
     *
    ...
    /**
     * Validierung der eingegebenen Daten vor dem Speichern. Es wird überprüft, ob der Namen des Teilnehmers ausgefüllt
     * wurde und dass er sich von den schon vorhandenen Namen unterscheidet.
     *
     * @param model Das Modell
    ...
    /**
     * Legt fuer den Teilnehmer alle Praeferenzen auf false und ruft anschließend speichereTeilnehmer auf
     *
     * @param model Das Modell
     */
